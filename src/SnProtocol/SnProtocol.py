...
"""
    ...
    def is_email(self):
        """  return True if data contains the character @ or else False"""
        try:
            self.data.index('@')
            return True
        except:
    ...
    def get_email(self):
        """  return a list of emails if there are emails in self.data"""
    ...
    def is_msg(self):
        """  return True if the self.data is a message or else False"""
        try:
    ...
    def get_msg(self):
        """  return the sent/received message """
    ...
    def is_msg_received(self):
        """ return True if the message is received or else False (use is_msg() before)"""
    ...
    def get_email_msg_sender(self):
        """ return the email of the sender of the received message (use is_msg_received() before)"""
        idx = self.data.index('MSG')
        data = self.data[idx:]
        return data.split()[1]
    ...
    def is_typing(self):
        """ return True if a user account is typing or else False"""
    ...
    def get_typing(self):
        """ return email of the user account typing (use is_typing() before)"""
